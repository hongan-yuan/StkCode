...
def parse_args(argv: list[str] | None = None):
    ...
    parser.add_argument("--tasks", type=int, default=4, help="number of concurrent jobs")
    ...
    if args.mode == "train" and any(
        ...
        parser.error(
            "training request count is generated by the Poisson process over one constellation cycle; "
...
def _job_specs(
    ...
    if args.mode == "train":
        total = _forwarded_int(forwarded, "--max-trace-slots", 606)
        unit = "slots"
    else:
