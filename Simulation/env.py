...
from .execution_agent import ServiceExecutionAgent, CandidateDecision
...
from .topology import load_temporal_graphs, slot_from_time
...
class SimulationEnvironment:
    ...
    def execute_request(self, request: SFCRequest, agent: ServiceExecutionAgent) -> dict:
        ...
        return {
            ...
            "reward": self._reward(finish_time - request.start_time, accumulated_energy, True),
