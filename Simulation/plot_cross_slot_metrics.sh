...
OUTPUT_DIR="${OUTPUT_DIR:-${INPUT_DIR}/cross_slot_plots}"
...
echo "Plotting 10-slot latency/energy curves"
...
plot_group() {
  ...
  echo "Plotting cross-slot group=${group_name}: ${group_ablations}"
  (
    cd "${PROJECT_ROOT}"
...
echo "Done. Cross-slot plots are under ${OUTPUT_DIR}."
