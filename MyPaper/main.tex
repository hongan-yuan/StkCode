...
We consider an SCPN built upon a classic Walker Delta LEO constellation, where satellites are connected through changing laser ISLs and equipped with constrained onboard computing and storage resources.
